...
<head>
    ...
    <link rel="stylesheet" href="../public/css/consoleStyles.css">
...
<body>
            ...
            <div>
                ...
                <div class="nav__list">
                    <div class="nav__items">
                        ...
                        <a href="consoles.php" class="nav__link active">
    ...
    <main>
        <div class="hero">
            ...
            <h1 class="glitch">
                    <span aria-hidden="true">Consoles</span>
                    Consoles
                    <span aria-hidden="true">Consoles</span></h1>
                <p>GamerSCerberus</p>
            </div>
            <div class="svg-hero" style="height: 150px; overflow: hidden;"><svg viewBox="0 0 500 150"
                    preserveAspectRatio="none" style="height: 100%; width: 100%;">
                    <path d="M0.00,49.98 C149.99,150.00 349.20,-49.98 500.00,49.98 L500.00,150.00 L0.00,150.00 Z"
                        style="stroke: none; fill: #4842E3;"></path>
                </svg></div>
        </div>  
        <h2 class="title">¡Buy your consoles!</h2>
        <div class="bg__card">
        <?php foreach($consoles as $product): ?>
            <div class="card">
                <div class="card__img">
    ...
    <!-- ------------------------------- fin footer ------------------------------- -->
    <script src="https://kit.fontawesome.com/a192df40a8.js" crossorigin="anonymous"></script>
